...
#line 37 "lilc_parser.cc" // lalr1.cc:404
...
#line 51 "lilc_parser.cc" // lalr1.cc:412
// Unqualified %code blocks.
#line 33 "lilc.yy" // lalr1.cc:413
...
#line 65 "lilc_parser.cc" // lalr1.cc:413
...
#line 5 "lilc.yy" // lalr1.cc:479
namespace LILC {
#line 132 "lilc_parser.cc" // lalr1.cc:479
  ...
  inline
  void
  LilC_Parser::basic_symbol<Base>::clear ()
  {
    Base::clear ();
  }
  ...
  inline
  bool
  LilC_Parser::basic_symbol<Base>::empty () const
  {
...
#line 564 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 3:
#line 135 "lilc.yy" // lalr1.cc:859
    {
			 (yystack_[1].value.declList)->push_back((yystack_[0].value.declNode));
			 (yylhs.value.declList) = (yystack_[1].value.declList);
			 }
#line 573 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 4:
#line 139 "lilc.yy" // lalr1.cc:859
    {
			(yylhs.value.declList) = new std::list<DeclNode *>();
			}
#line 581 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 5:
#line 144 "lilc.yy" // lalr1.cc:859
    {
		//Make sure to fill out this rule

}
#line 590 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 6:
#line 149 "lilc.yy" // lalr1.cc:859
    {
  (yylhs.value.varDeclNode) = new VarDeclNode((yystack_[2].value.typeNode), (yystack_[1].value.idNode), VarDeclNode::NOT_STRUCT);
}
#line 598 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 7:
#line 153 "lilc.yy" // lalr1.cc:859
    { (yylhs.value.typeNode) = new IntNode(); }
#line 604 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 8:
#line 154 "lilc.yy" // lalr1.cc:859
    { (yylhs.value.typeNode) = new BoolNode(); }
#line 610 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 9:
#line 155 "lilc.yy" // lalr1.cc:859
    { (yylhs.value.typeNode) = new VoidNode(); }
#line 616 "lilc_parser.cc" // lalr1.cc:859
    break;

  case 10:
#line 157 "lilc.yy" // lalr1.cc:859
    { (yylhs.value.idNode) = new IdNode((yystack_[0].value.idTokenValue)); }
#line 622 "lilc_parser.cc" // lalr1.cc:859
    break;


#line 626 "lilc_parser.cc" // lalr1.cc:859
            default:
              break;
            }
        }
  ...
  std::string
  LilC_Parser::yysyntax_error_ (state_type, const symbol_type&) const
  {
    return YY_("syntax error");
  }


  const signed char LilC_Parser::yypact_ninf_ = -20;
  ...
  {
       0,   128,   128,   135,   139,   144,   149,   153,   154,   155,
     157
  };
...
#line 5 "lilc.yy" // lalr1.cc:1167
} // LILC
#line 957 "lilc_parser.cc" // lalr1.cc:1167
#line 158 "lilc.yy" // lalr1.cc:1168
